...
#Start a regular bool loop
while True:
    #Ask user for power choice
    choice = input("What is your chosen power? (Lightning or Fire?)")
    #If user picks proper choice break out of while loop. This continues game
    if choice == "Lightning" or choice == "lightning" or choice == "Fire" or choice == "fire":
        break
    #If user picks anything else loop back
    else:
